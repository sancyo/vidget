    ...
    <main class="main-container">
      <div class="main-content">
        ...
        <p>
          ...
          これらはトラフィックデータの収集のためにCookieを使用しています。
        ...
        <p>
          ...
          <a
            ...
            class="link"
          >
            <span class="link"> 「広告 – ポリシーと規約 – Google」</span></a
          >を御覧ください。
        ...
        <h2>個人情報の利用目的</h2>
        <p>
          本ウェブサイトでは、お客様からのお問い合わせ時に、e-mailアドレス等の個人情報をご登録いただく場合がございますが、これらの個人情報はご提供いただく際の目的以外では利用いたしません。
        ...
        <ul>
          ...
          <li>法令に基づき開示することが必要である場合 個人情報の安全対策</li>
          <li>
            当サイトまたは第三者であるユーザーの権利・財産を保護するために必要だと運営が合理的に判断した場合。
          </li>
        </ul>
        <p>
...
ul {
  padding: 1.8rem 1rem 1.8rem 3.2rem;
}
li {
  padding-left: 1rem;
  line-height: 1.5;
