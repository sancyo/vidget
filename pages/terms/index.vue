    ...
    <div class="main-container">
      <div class="main-content">
        ...
        <p>
          ...
          Vidget（以下，「本サービス」といいます。）の利用条件を定めるものです。本サービスを利用する皆様（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        ...
        <ol>
          <li>
            登録希望者が本規約に同意の上，本サービスの定める方法によって利用登録を申請し，本サービスがこれを承認することによって，利用登録が完了するものとします。
          </li>
          <li>
        ...
        <ol>
          ...
          <li>
            ユーザーは本サイトのコンテンツを無断で使用することを認めます。
